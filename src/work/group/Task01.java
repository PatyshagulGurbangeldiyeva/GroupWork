...
public class Task01 {
	...
	public static void main(String[] args) {
		...
		x=x+y; // x=9+20---> x=29, y=20
		y=x-y; // y=29-20---> x=29, y=9
		x=x-y; // x=29-9----> x=20, y=9 -----> here we swapped our variable
		...
		// here we will use * and /
		// but the values musn't be equal to zero (0)
